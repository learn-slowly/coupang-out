...
## 64,250개의 장벽, 기울어진 검색창

소상공인 '하민' 씨는 쿠팡에 입점해 공정한 경쟁을 꿈꿨다. 하지만 그의 상품은 아무리 노력해도 검색 상단에 오르지 못했다. 쿠팡이 알고리즘을 조작해 자기들의 PB상품(자체브랜드)과 직매입 상품 64,250개를 상단에 고정 노출시켰기 때문이다. 공정위가 이를 적발해 과징금을 부과했지만, 하민 씨의 가게는 이미 투명인간 취급을 받으며 문을 닫은 뒤였다. '혁신'이라 불린 로켓배송 뒤에는 소상공인의 눈물이 있었다.[13]
...
[13] 공정위, '알고리즘 조작' 쿠팡에 과징금 1400억 부과 https://www.korea.kr/news/policyNewsView.do?newsId=148929949
...
export const stories = [
  {
    ...
    title: "새벽 4시의 심정지",
    subtitle: "편리함 뒤에 가려진 28명의 죽음, 3,370만 명의 개인정보 유출. 우리는 더 이상 침묵하지 않습니다.",
...
### [제5장] CEO 지키기 (책임 회피와 꼬리 자르기) **(★신규 추가)**

**개요:** 노동자의 죽음 직후, 책임을 피하기 위해 움직였던 경영진의 민낯을 고발합니다.

* **장면 묘사:** 차갑고 어두운 사무실. 긴 회의 테이블 위에 덩그러니 놓인 구형 타자기 하나가 혼자서 문서를 작성하고 있다. 주변에는 검은 정장의 실루엣들이 보일 듯 말 듯 서 있다. Noir 영화 같은 분위기.
* **🖼️ AI 이미지 생성 프롬프트:**
> A dark, cold corporate meeting room. A vintage typewriter sits alone on a long mahogany table, typing by itself. Silhouettes of faceless executives in suits stand in the shadows. Cinematic noir style, mysterious and ominous atmosphere, high contrast.

* **📝 화면 텍스트 (타자기 효과):**
> **[지시사항]**
> "2020년 10월, 칠곡물류센터 故 장덕준 씨 과로사 사건 직후."
> "모두가 비통해하던 그 시각, 경영진은 대책 회의를 열었습니다."
>
> **[CONFIDENTIAL]**
> *   "열심히 일했다는 기록이 남지 않도록 하라."
> *   "그가 왜 열심히 일하겠나? 시간제인데.. 말이 안 된다."
>
> **[SOURCE]**
> 당시 최고경영자(CEO)의 발언 (SBS 단독 보도)
