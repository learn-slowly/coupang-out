...
export default function StorySection({ story, index }: { story: Story; index: number }) {
    ...
    return (
        <section
            ref={containerRef}
            className="min-h-screen w-full relative flex items-start pt-24 md:items-center md:justify-center md:pt-0 overflow-hidden border-t border-zinc-900 bg-zinc-950"
        >
            {renderBackground()}
